...
export const FeaturesGrid = () => {
  return (
    <section className="my-10 px-4">
      <div className="rounded-[2.5rem] py-16 relative overflow-hidden bg-gray-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 px-6">
            {features.map((item, index) => (
              ...
              >
                ...
                <div className="mb-6 text-black/80 group-hover:text-black group-hover:scale-110 transition-all duration-300">
                  {item.icon}
                </div>
                ...
                <p className="text-sm text-gray-11 font-medium leading-relaxed max-w-45">
                  {item.desc}
                </p>

                {/* خط تزیینی */}
                <div className="w-8 h-1 bg-black/20 mt-6 rounded-full group-hover:w-16 group-hover:bg-black/40 transition-all duration-500" />
              </div>
            ))}
          </div>
        </div>
