...
import PaymentButton from "../components/ShoppingCardComponents/PaymentButton";
import EmptyState from "../components/CommonComponents/EmptyState";
import type { Metadata } from "next";

export const metadata: Metadata = {
  title: "سبد خرید",
  description: "محصولات انتخاب‌شده خود را بررسی کنید و برای ادامه خرید به مرحله پرداخت بروید.",
  robots: {
    index: false,
    follow: false,
  },
